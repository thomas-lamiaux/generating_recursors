...
MetaCoq Run (tmPrint "Test t11 strpos uprams").
...
MetaCoq Run (tmPrint "Test non_strpos").
...
MetaCoq Run (tmPrint "Test non_strpos2").
...
MetaCoq Run (tmPrint "Test non_strpos3").
...
MetaCoq Run (tmPrint "Test non_strpos4").
...
MetaCoq Run (tmPrint "Test non_strpos5").
...
MetaCoq Run (tmPrint "Test non_strpos6").
...
MetaCoq Run (tmPrint "Test non_strpos7").
...
MetaCoq Run (tmPrint "Test non_strpos8").
...
MetaCoq Run (tmPrint "Test non_strpos9").
