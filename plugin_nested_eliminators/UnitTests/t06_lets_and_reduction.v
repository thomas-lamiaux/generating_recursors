...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_01_b_let_coq" MetaRocq Run (print_rec "b_let").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_01_b_let_gen" MetaRocq Run (generate Ep b_let).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_02_rc_let_coq" MetaRocq Run (print_rec "rc_let").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_02_rc_let_gen" MetaRocq Run (generate Ep rc_let).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_03_rc_letpar_coq" MetaRocq Run (print_rec "rc_letpar").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_03_rc_letpar_gen" MetaRocq Run (generate Ep rc_letpar).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_04_crazy1_coq" MetaRocq Run (print_rec "crazy1").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_04_crazy1_gen" MetaRocq Run (generate Ep crazy1).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_05_crazy2_coq" MetaRocq Run (print_rec "crazy2").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_05_crazy2_gen" MetaRocq Run (generate Ep crazy2).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_06_diag_coq" MetaRocq Run (print_rec "diag").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_06_diag_gen" MetaRocq Run (generate Ep diag).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_07_redc_coq" MetaRocq Run (print_rec "redc").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_07_redc_gen" MetaRocq Run (generate Ep redc).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_08_redEnv_coq" MetaRocq Run (print_rec "redEnv").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_08_redEnv_gen" MetaRocq Run (generate Ep redEnv).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_09_nu_let1_coq" MetaRocq Run (print_rec "nu_let1").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_09_nu_let1_gen" MetaRocq Run (generate Ep nu_let1).
...
Redirect "plugin_nested_eliminators/UnitTests/tests/06_10_nu_let2_coq" MetaRocq Run (print_rec "nu_let2").
Redirect "plugin_nested_eliminators/UnitTests/tests/06_10_nu_let2_gen" MetaRocq Run (generate Ep nu_let2).