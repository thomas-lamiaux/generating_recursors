...
MetaRocq Run (tmMsg "01/15 RoseTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_01_RoseTree_coq" MetaRocq Run (print_rec "RoseTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_01_RoseTree_gen" MetaRocq Run (generate Ep RoseTree).
...
MetaRocq Run (tmMsg "02/15 PairTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_02_PairTree_coq" MetaRocq Run (print_rec "PairTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_02_PairTree_gen" MetaRocq Run (generate Ep PairTree).
...
MetaRocq Run (tmMsg "03/15 ArrowTree1").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_03_ArrowTree1_coq" MetaRocq Run (print_rec "ArrowTree1").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_03_ArrowTree1_gen" MetaRocq Run (generate Ep ArrowTree1).
...
MetaRocq Run (tmMsg "04/15 ArrowTree2").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_04_ArrowTree2_coq" MetaRocq Run (print_rec "ArrowTree2").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_04_ArrowTree2_gen" MetaRocq Run (generate Ep ArrowTree2).
...
MetaRocq Run (tmMsg "05/15 ArrowTree3").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_05_ArrowTree3_coq" MetaRocq Run (print_rec "ArrowTree3").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_05_ArrowTree3_gen" MetaRocq Run (generate Ep ArrowTree3).
...
MetaRocq Run (tmMsg "06/15 LeftTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_06_LeftTree_coq" MetaRocq Run (print_rec "LeftTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_06_LeftTree_gen" MetaRocq Run (generate Ep LeftTree).
...
MetaRocq Run (tmMsg "07/15 RightTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_07_RightTree_coq" MetaRocq Run (print_rec "RightTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_07_RightTree_gen" MetaRocq Run (generate Ep RightTree).
...
MetaRocq Run (tmMsg "08/15 NestedTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_08_NestedTree_coq" MetaRocq Run (print_rec "NestedTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_08_NestedTree_gen" MetaRocq Run (generate Ep NestedTree).
...
MetaRocq Run (tmMsg "09/15 VecTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_09_VecTree_coq" MetaRocq Run (print_rec "VecTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_09_VecTree_gen"    MetaRocq Run (generate Ep VecTree).
...
MetaRocq Run (tmMsg "10/15 WTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_10_WTree_coq" MetaRocq Run (print_rec "WTree").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_10_WTree_gen" MetaRocq Run (generate Ep WTree).
...
MetaRocq Run (tmMsg "11/15 nu_nested").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_11_nu_nested_coq" MetaRocq Run (print_rec "nu_nested").
Redirect "plugin_nested_eliminators/UnitTests/tests/07_11_nu_nested_gen" MetaRocq Run (generate Ep nu_nested).
...
(* MetaRocq Run (tmMsg "12/15 tricky1"). *)
Redirect "plugin_nested_eliminators/UnitTests/tests/07_12_tricky1_coq" MetaRocq Run (print_rec "tricky1").
(* BUGS ISSUE UNIVERSE LEVEL *)
(* Redirect "plugin_nested_eliminators/UnitTests/tests/07_12_tricky1_gen" MetaRocq Run (generate Ep tricky1). *)
...
(* MetaRocq Run (tmMsg "13/15 tricky2"). *)
Redirect "plugin_nested_eliminators/UnitTests/tests/07_13_tricky3_coq" MetaRocq Run (print_rec "tricky2").
(* BUGS ISSUE UNIVERSE LEVEL *)
(* Redirect "plugin_nested_eliminators/UnitTests/tests/07_13_tricky_gen" MetaRocq Run (generate Ep tricky2). *)
...
(* MetaRocq Run (tmMsg "14/15 tricky3"). *)
Redirect "plugin_nested_eliminators/UnitTests/tests/07_14_tricky3_coq" MetaRocq Run (print_rec "tricky3").
(* BUGS ISSUE UNIVERSE LEVEL *)
(* Redirect "plugin_nested_eliminators/UnitTests/tests/07_14_tricky_gen" MetaRocq Run (generate Ep tricky3). *)
...
Redirect "plugin_nested_eliminators/UnitTests/tests/07_15_typing_coq" MetaRocq Run (print_rec "typing").
(* Redirect "plugin_nested_eliminators/UnitTests/tests/07_15_typing_gen" MetaRocq Run (generate Ep ( @typing)). *)
