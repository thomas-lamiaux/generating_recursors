...
(* 1. Core  *)
From NamedAPI Require Export core.
(*
- state : Type
- init_state : state
...
From NamedAPI Require Export fold_functions.
(*
...
From NamedAPI Require Export debug_functions.
(*
...
(* 4. Access the inductive type *)
From NamedAPI Require Export inductive_access.
(*
...
From NamedAPI Require Export inductive_store.
(*
...
(* 6. Acces the context *)
From NamedAPI Require Export context_access.
(*
...
From NamedAPI Require Export context_store.
(*
...
(* 8. Interface to create terms *)
From NamedAPI Require Export creating_terms.
(*
