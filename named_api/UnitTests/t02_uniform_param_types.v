...
Redirect "named_api/UnitTests/tests/02_01_list_coq" MetaRocq Run (print_rec "list").
Redirect "named_api/UnitTests/tests/02_01_list_gen" MetaRocq Run (generate [] list).
...
Redirect "named_api/UnitTests/tests/02_02_prod_coq" MetaRocq Run (print_rec "prod").
Redirect "named_api/UnitTests/tests/02_02_prod_gen" MetaRocq Run (generate [] prod).
...
Redirect "named_api/UnitTests/tests/02_03_sum_coq" MetaRocq Run (print_rec "sum").
Redirect "named_api/UnitTests/tests/02_03_sum_gen" MetaRocq Run (generate [] sum).
...
Redirect "named_api/UnitTests/tests/02_04_prod4_coq" MetaRocq Run (print_rec "prod4").
Redirect "named_api/UnitTests/tests/02_04_prod4_gen" MetaRocq Run (generate [] prod4).
...
Redirect "named_api/UnitTests/tests/02_05_ftree_coq" MetaRocq Run (print_rec "ftree").
Redirect "named_api/UnitTests/tests/02_05_ftree_gen" MetaRocq Run (generate [] ftree).
...
Redirect "named_api/UnitTests/tests/02_06_ftree2_coq" MetaRocq Run (print_rec "ftree2").
Redirect "named_api/UnitTests/tests/02_06_ftree2_gen" MetaRocq Run (generate [] ftree2).
...
Redirect "named_api/UnitTests/tests/02_07_tricky_coq" MetaRocq Run (print_rec "tricky").
Redirect "named_api/UnitTests/tests/02_07_tricky_gen" MetaRocq Run (generate [] tricky).
