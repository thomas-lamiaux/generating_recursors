...
Redirect "recursors_named/tests/06_01_b_let_coq" MetaCoq Run (print_rec "b_let_ind").
...
Redirect "recursors_named/tests/06_03_rc_let_coq" MetaCoq Run (print_rec "rc_let_ind").
...
Redirect "recursors_named/tests/06_04_rc_let_coq" MetaCoq Run (print_rec "rc_letlet_ind").
...
Redirect "recursors_named/tests/06_05_crazy_coq" MetaCoq Run (print_rec "crazy_ind").
