...
Redirect "recursors_named/tests/03_03_vec3_coq" MetaCoq Run (print_rec "vec3_ind").
...
Redirect "recursors_named/tests/03_04_vec4_coq" MetaCoq Run (print_rec "vec4_ind").
...
Redirect "recursors_named/tests/03_05_eq_coq" MetaCoq Run (print_rec "eq_ind").
Redirect "recursors_named/tests/03_05_eq_gen" MetaCoq Run (gen_rec [] <% eq %>).