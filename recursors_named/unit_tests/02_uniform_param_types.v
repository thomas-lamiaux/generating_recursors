...
(* List *)
Redirect "recursors_named/tests/02_01_list_coq" MetaCoq Run (print_rec "list").
Redirect "recursors_named/tests/02_01_list_gen" MetaCoq Run (gen_rec [] <% list %>).

(* Prod *)
Redirect "recursors_named/tests/02_02_prod_coq" MetaCoq Run (print_rec "prod").
Redirect "recursors_named/tests/02_02_prod_gen" MetaCoq Run (gen_rec [] <% prod %>).

(* Sum *)
Redirect "recursors_named/tests/02_03_sum_coq" MetaCoq Run (print_rec "sum").
...
Redirect "recursors_named/tests/02_04_prod4_coq" MetaCoq Run (print_rec "prod4").
